...
public abstract class Notificator {
    ...
    public void send(Notification notification, User user, Device device, Event event, Position position) throws MessageException {
        var message = notificationFormatter.formatMessage(notification, user, event, position, templatePath);
        send(user, message,device, event, position);
    }
